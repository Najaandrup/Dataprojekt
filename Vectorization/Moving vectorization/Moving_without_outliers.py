...
def vectorize_and_plot(tsv_file, pod_file, vector_length, window_size_avg, window_size_var, threshold):
    ...
    plt.title(f"Moving Average - Normalized with n={vector_length}, w={window_size_avg}, t={threshold}")
    plt.xlabel("Window Index")
    plt.ylabel("Normalized Mean")
    plt.legend()
    plt.grid(True)
    mean_plot_name = f"{base_name}_mean_n{vector_length}_w{window_size_avg}_t{threshold}_outlier_removed.png"
    ...
    plt.title(f"Moving Variation - Normalized with n={vector_length}, w={window_size_var}, t={threshold}")
    plt.xlabel("Window Index")
    plt.ylabel("Variance")
    plt.legend()
    plt.grid(True)
    var_plot_name = f"{base_name}_var_n{vector_length}_w{window_size_var}_t{threshold}_outlier_removed.png"
